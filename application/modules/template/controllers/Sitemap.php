...
class Sitemap extends MX_Controller {
    ...
    // ["city" => "Salem", "state" => "tamil-nadu"]
        ...
        $static_pages = [
            ...
            ['household-shifting', '0.8', 'monthly'],
            ['office-shifting', '0.8', 'monthly'],
            ['local-shifting', '0.8', 'monthly'],
            ['domestic-shifting', '0.8', 'monthly'],
            ['international-shifting', '0.8', 'monthly'],
            ['car-transportation-service', '0.8', 'monthly'],
            ['bike-transportation-service', '0.8', 'monthly'],
            ['loading-and-unloading', '0.8', 'monthly'],
            ['packing-and-moving', '0.8', 'monthly'],
            ['warehouse-and-storage-services', '0.8', 'monthly'],
            ['reviews', '0.9', 'weekly'],
            ['contact-us', '0.7', 'monthly'],
            ['blog', '0.7', 'weekly'],
            ['photo-gallery', '0.6', 'monthly'],
            ['video-gallery', '0.6', 'monthly'],
            ['branch-address', '0.8', 'monthly'],
            ['our-location', '0.8', 'monthly'],
            ['why-choose-us', '0.7', 'monthly'],
            ['mission-and-vision', '0.7', 'monthly'],
            ['iba-approved-packers', '0.7', 'monthly'],
            ['faqs', '0.7', 'monthly'],
            ['certificates', '0.7', 'monthly'],
            ['iso-certification', '0.7', 'monthly'],
            ['payment-mode', '0.6', 'monthly'],
            ['award-gallery', '0.6', 'monthly'],
            ['our-philosophy', '0.6', 'monthly'],
            ['privacy-policy', '0.3', 'yearly'],
            ['terms-and-conditions', '0.3', 'yearly'],
            ['refund-policy', '0.3', 'yearly'],
            ['disclaimer', '0.3', 'yearly'],
            ['moving-guide', '0.6', 'monthly'],
            ['packing-material', '0.6', 'monthly'],
            ['avoid-fraud-packers-and-movers', '0.6', 'monthly'],
            ['sitemap', '0.4', 'monthly'],
        ];

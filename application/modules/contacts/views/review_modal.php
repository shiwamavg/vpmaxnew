        ...
        <div class="modal-content border-0 contact-review-modal-content">
            ...
            <div class="modal-body p-3">
                <form action="<?= site_url('reviews/submit') ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-2">
                        <label for="review-name" class="contact-review-form-label mb-1">Your Full Name</label>
                        <input type="text" id="review-name" name="name" class="form-control contact-review-form-control form-control-sm" placeholder="Enter your name" required>
                    </div>
                    <div class="mb-2">
                        <label for="review-email" class="contact-review-form-label mb-1">Your Email</label>
                        <input type="email" id="review-email" name="email" class="form-control contact-review-form-control form-control-sm" placeholder="Enter your email" required>
                    </div>
                    <div class="mb-2">
                        <label for="review-city" class="contact-review-form-label mb-1">Your City</label>
                        <input type="text" id="review-city" name="city" class="form-control contact-review-form-control form-control-sm" placeholder="e.g. Lucknow" value="<?= isset($city) ? $city : '' ?>" required>
                    </div>
                    <div class="mb-2">
                        <label for="review-images-input" class="contact-review-form-label mb-1">Upload Images (Max 4)</label>
                    ...
                    <div class="mb-2">
                        <label for="rating-input" class="contact-review-form-label mb-1">Your Rating</label>
                    ...
                    <div class="mb-2">
                        <label for="review-message" class="contact-review-form-label mb-1">Your Message</label>
                        <textarea id="review-message" name="review" class="form-control contact-review-form-control form-control-sm" rows="3" placeholder="Write your feedback here..." required></textarea>
                    </div>
